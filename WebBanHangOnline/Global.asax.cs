...
namespace WebBanHangOnline
{
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_BeginRequest()
        {
            ...
            /*var isAdminRequest = context.Request.Url.AbsolutePath.StartsWith("/Admin");

            if (isAdminRequest)
            {
                AntiForgeryConfig.CookieName = "AdminAntiForgeryCookie";
            }
            else
            {
                AntiForgeryConfig.CookieName = "ClientAntiForgeryCookie";
            }*/
        }
